...
$sql="INSERT INTO product (product_name,product_desc,product_price,product_weight,product_available,product_on_hand,vendor_id,product_parent_id,product_full_image)
VALUES('$name','$desc','$price','$weight','$available','$on_hand','$vendor_id','$product_parent_id','$nameimages')";
